...
double Adafruit_MLX90614::readObject1TempC(void) {
  return readTemp(MLX90614_TOBJ1);
}
double Adafruit_MLX90614::readObject2TempC(void) {
...
uint16_t Adafruit_MLX90614::test_read(uint16_t *pec_s){
	uint16_t ret;

  Wire.beginTransmission(_addr); // start transmission to device 
  Wire.write(MLX90614_TA); // sends register address to read from
